...
class BridgeConfig:
    def __init__(self, host: str, port: int):
        ...
        self.volcengine_app_id = VOLCENGINE_APP_ID.strip()
        self.volcengine_access_token = VOLCENGINE_ACCESS_TOKEN.strip()
    ...
    def ready(self):
        return bool(self.volcengine_app_id and self.volcengine_access_token and self.resource_id and self.speaker and self.tts_url)
...
class StreamingSynthesizer:
    ...
    def _build_request(self) -> dict:
        ...
        # Matches Volcengine v3 unidirectional streaming API (SeedTTS 2.0).
        return {
            "user": {
    ...
    def _run(self):
        headers = {
            ...
            "X-Api-App-Id": self.config.volcengine_app_id,
            "X-Api-Access-Key": self.config.volcengine_access_token,
