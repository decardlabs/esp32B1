...
static void xl9555_board_output_init(uint8_t port, uint8_t pin, bool level)
{
    xl9555_set_pin_dir(port, pin, 0);
    xl9555_set_pin_level(port, pin, level);
}

static void xl9555_board_input_init(uint8_t port, uint8_t pin)
{
    xl9555_set_pin_dir(port, pin, 1);
}
...
void ws2812_txs0108_enable(void)
{
...
{
    xl9555_board_output_init(TFT_PORT, TFT_RES_PIN, 1);
    xl9555_board_output_init(TFT_PORT, TFT_BLK_PIN, 0);
}

void board_camera_gpio_init(void)
{
    xl9555_board_output_init(OV_PORT, OV_RESET_PIN, 0);
    xl9555_board_output_init(OV_PORT, OV_PWDN_PIN, 1);
}

void board_audio_gpio_init(void)
{
    xl9555_board_output_init(SPK_PORT, SPK_PIN, 1);
    xl9555_board_output_init(BEEP_PORT, BEEP_PIN, 1);
}

void board_keys_gpio_init(void)
{
    xl9555_board_input_init(KEY_PORT, KEY1_PIN);
    xl9555_board_input_init(KEY_PORT, KEY2_PIN);
    xl9555_board_input_init(KEY_PORT, KEY3_PIN);
    xl9555_board_input_init(KEY_PORT, KEY4_PIN);
}

void board_ws2812_level_shifter_init(void)
{
    xl9555_board_output_init(TXS0108_PORT, TXS0108_PIN, 1);
}

void board_xl9555_init(void)
{
    xl9555_init();
    board_lcd_gpio_init();
    board_camera_gpio_init();
